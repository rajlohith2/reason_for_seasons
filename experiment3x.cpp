...
glPopMatrix();
glColor3f(1,0,0);
DrawTextXY(-11,7,-10,0.0060," AUTUMNAL EQUINOX ");
glColor3f(1,0,0);
DrawTextXY(0.7,7.5,-10,0.0040," / ");
glColor3f(1,0,0);
DrawTextXY(1,8,-10,0.0020," 23 DEGREE TILT ");
DrawTextXY(-1,0,-10,0.0080," ^");
DrawTextXY(-3,0,-10,0.0080," ^");
DrawTextXY(1,0,-10,0.0080," ^");
DrawTextXY(-2.11,-1.5,-10,0.020," |");
DrawTextXY(-4.11,-1.5,-10,0.020," |");
DrawTextXY(-0.11,-1.5,-10,0.020," |");
DrawTextXY(2.7,4,-10,0.0020,"--------------EQUATOR");
DrawTextXY(2.5,0,-10,0.0020,"DIRECT SUN RAYS ON EQUATOR");
DrawTextXY(-11,4,-10,0.0020,"AUTUMN IN NORTHERN HEMISPHERE");
DrawTextXY(-11,2,-10,0.0020,"SPRING IN SOUTHERN HEMISPHERE");
DrawTextXY(-14,5,-10,0.0020,"AVERAGE TEMPERATURE IN INDIA: 25 C");
	 glutSwapBuffers();

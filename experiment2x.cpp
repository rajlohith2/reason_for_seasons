...
glPopMatrix();
 ...
 void display(void)
{
	GLfloat position[]={-2.0,0.0,3.5,0.5};
     glClearDepth(1);
  ...
  glColor3f(245/256.0,222/256.0,179/256.0);
     ...
     angle++;
     DisplaySphere(2, texture[0]);   // To display the sphere funtion which will set the size of it to 5 and assign the texture specified. it inputs the radius and texture
	glPopMatrix();
//glPushMatrix();
...
//glDisable(GL_LIGHTING);
glEnable(GL_LIGHTING);
glTranslated(-3.5,0.0,3);
glColor3f(1.5,0.5,0.0);
glutSolidTorus(0.8,2,6,20);
glPopMatrix();
/*glColor3f(1,0,0);
...
glPopMatrix();
glColor3f(1,0,0);
DrawTextXY(-3,6,-10,0.0060," WINTER SOLSTICE ");
glColor3f(1,0,0);
DrawTextXY(7,2.9,-10,0.0040," / ");
glColor3f(1,0,0);
DrawTextXY(6.8,3.5,-10,0.0020," 23 DEGREE TILT ");
DrawTextXY(-1,1,-10,0.0080," >");
DrawTextXY(-2,1.25,-10,0.0020,"----------------------");
DrawTextXY(-1,-1,-10,0.0080," >");
DrawTextXY(-2,-0.75,-10,0.0020,"----------------------");
DrawTextXY(6,-5,-10,0.0020,"TROPIC OF CAPRICORN--");
DrawTextXY(9.35,-4.85,-10,0.0020,"|");
DrawTextXY(9.35,-4.55,-10,0.0020,"|");
DrawTextXY(9.35,-4.25,-10,0.0020,"|");
DrawTextXY(9.35,-3.95,-10,0.0020,"|");
DrawTextXY(9.35,-3.65,-10,0.0020,"|");
DrawTextXY(9.35,-3.35,-10,0.0020,"|");
DrawTextXY(9.35,-3.05,-10,0.0020,"|");
DrawTextXY(9.35,-2.75,-10,0.0020,"|");
DrawTextXY(9.35,-2.45,-10,0.0020,"|");
DrawTextXY(-3,-5,-10,0.0020,"DIRECT SUN RAYS ON TROPIC OF CAPRICORN");
DrawTextXY(-5,-6,-10,0.0020,"WINTER IN NORTHERN HEMISPHERE,SUMMER IN SOUTHERN HEMISPHERE");
DrawTextXY(9,5,-10,0.0020,"AVERAGE TEMPERATURE IN INDIA: 18 C");
	 glutSwapBuffers();

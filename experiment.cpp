...
DrawTextXY(-3.4,1,-10,0.0020,"--TROPIC OF CANCER");
DrawTextXY(-4,-5,-10,0.0020,"DIRECT SUN RAYS ON TROPIC OF CANCER");
DrawTextXY(-14,-4,-10,0.0020,"SUMMER IN THE NORTHERN HEMISPHERE ");
DrawTextXY(-14,-4.4,-10,0.0020,"WINTER IN THE SOUTHERN HEMISPHERE");
DrawTextXY(-14,4,-10,0.0020,"AVERAGE TEMPERATURE IN INDIA: 32C");
 glutSwapBuffers();
